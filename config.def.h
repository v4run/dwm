...
static const char *fonts[] = {
    "monospace:size=10",
    "FantasqueSansMono Nerd Font Mono:style=Regular:size=15"};
...
static const char *upvol[] = {
    "sh", "-c", "/usr/bin/pamixer --increase 2 && kill -36 $(pidof goblocks)",
    NULL};
static const char *downvol[] = {
    "sh", "-c", "/usr/bin/pamixer --decrease 2 && kill -36 $(pidof goblocks)",
    NULL};
static const char *mutevol[] = {
    "sh", "-c", "/usr/bin/pamixer --toggle-mute && kill -36 $(pidof goblocks)",
    NULL};
...
static const char *dmenucmd[] = {"dmenu_run", "-i",
                                 "-m",        dmenumon,
                                 "-fn",       dmenufont,
                                 "-nb",       col_norm_bg,
                                 "-nf",       col_norm_fg,
...
static const char *musiccmd[] = {"st",    "-t", "ncmpcpp", "-c",
                                 "Music", "-e", "ncmpcpp", NULL};
static const char *screenshotcmd[] = {
    "scrot", "-s", "-e", "xclip -selection clipboard -t image/png -i $f", NULL};
