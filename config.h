...
static const unsigned int statusonmainmonitor =
	1; /* 0: show status bar on selmon, 1: show statusbar on main monitor */
...
static const char  col_gray3[] = "#fffcfa";
static const char  col_gray4[] = "#fe8019";
static const char  col_cyan[]  = "#9d65ff";
...
static const char *colors[][3] = {
	...
	[SchemeSelTitle]  = {col_gray3, col_gray1, col_gray1},
	[SchemeSeparator] = {col_gray2, col_gray1, col_gray1},
};

/* tagging */
static const char *tags[]  = {"1", "2", "3", "4", "5", "6", "7", "8", "9"};
// static const char *tags[] = { "１", "２", "３", "４", "５",
// 			      "６", "７", "８", "９" };
...
static const int    nmasterportrait = 2;    /* number of clients in master area (portrait)*/
...
static const char *poweroptionscmd[] = {"dmenu_power", "-m",  dmenumon,  "-fn", dmenufont, "-nb",
                                        col_gray1,     "-nf", col_gray3, "-sb", col_cyan,  "-sf",
                                        col_gray1,     "-i",  "-l",      "4",   NULL};
